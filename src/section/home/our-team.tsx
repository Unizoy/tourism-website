  ...
  return (
    <div className="relative bg-white pt-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 flex flex-col lg:flex-row justify-between items-center lg:items-start gap-12">
          {/* Left content */}
          <div className="flex flex-col items-center lg:items-start gap-12 lg:gap-80 w-full lg:w-1/3">
          ...
          <div
            ref={imagesRef}
            className="images relative w-full lg:w-2/3 h-[400px] lg:h-[600px] flex justify-center state-1"
          >
            {leaders.map((leader) => (
              <Image
                key={leader.id}
            ...
            <div className="flex justify-center gap-4 absolute bottom-6">
              <button
          ...
          {/* Right content */}
          <div className="max-w-md flex flex-col lg:flex-row items-center lg:items-start mt-12 lg:mt-40 gap-6 w-full lg:w-1/3 text-center lg:text-left">
            <div>
